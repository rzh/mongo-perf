...
// geoWithin
tests.push( { name: "Geo.within.center",
...
tests.push( { name: "Geo.within.center.offcenter",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.box",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.box.offcenter",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.centerSphere",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.centerSphere.offcenter",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
// findOne
tests.push( { name: "Geo.within.center.findOne",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.center.findOne.offcenter",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.box.findOne",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
...
tests.push( { name: "Geo.within.box.findOne.offcenter",
              pre: function( collection ) { 
              	  collection.drop(); 
                  collection.ensureIndex({loc: "2d"});
                  generateGridMap(collection, -50, -50, 50, 50);
